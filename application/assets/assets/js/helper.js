...
function toaster(text, time) {
    ...
    $("div#toast").animate({ top: "0px" }, time, "linear", function() {
        $("div#toast").delay(time).animate({ top: "-110vh" }, time);
...
function bottom_bar(left, center, right) {
    ...
    left == "" ? $("div#bottom-bar div#button-left").css("opacity", "0") : $("div#bottom-bar div#button-left").css("opacity", "1");
    center == "" ? $("div#bottom-bar div#button-center").css("opacity", "0") : $("div#bottom-bar div#button-center").css("opacity", "1");
    left == "" ? $("div#bottom-bar div#button-right").css("opacity", "0") : $("div#bottom-bar div#button-right").css("opacity", "1");
