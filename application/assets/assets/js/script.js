$(document).ready(function() {
    ...
    function sleep() {
        ...
        //do not set alarm because is running
        if (sleepModeRunning == "true") {
            $('div.alarms').append('<div class=time>' + "sleep mode activ" + "</div>")
        }
        //set alarm
        if (sleepModeRunning == "false" || sleepModeRunning == null) {
            ...
            setTimeout(
                function() {
                    ...
                    alarmInterval(m, n)
                    getAlarms()
                    $('div.alarms div.time').css("color", "blue")
                }, 3000);
    ...
    function getCityName() {
        ...
        var jqxhr = $.getJSON(request_url, function(data) {
            ...
            .fail(function() {
                toaster("location name cen't be loadede", 3000)
            })
            .always(function() {});
